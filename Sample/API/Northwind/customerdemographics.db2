...
*--------------------------------------------------------------------------------------------------------------------------------------------------------
*< FOXBIN2PRG: Version="1.19" SourceFile="customerdemographics.dbf" /> (Solo para binarios VFP 9 / Only for VFP 9 binaries)
*
...
<TABLE>
	...
	<FIELDS>
		<FIELD>
			...
			<LongTableName>CUSTOMERDEMOGRAPHICS</LongTableName>
			<Ins_Trig_Exp></Ins_Trig_Exp>
			<Upd_Trig_Exp>__ri_update_customerdemographics()</Upd_Trig_Exp>
			<Del_Trig_Exp>__ri_delete_customerdemographics()</Del_Trig_Exp>
	...
	<indexFile>CUSTOMERDEMOGRAPHICS.CDX</indexFile>
